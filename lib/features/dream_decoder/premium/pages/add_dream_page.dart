...
class _AddDreamPageState extends State<AddDreamPage> {
  ...
  void _send() {
    context.router.push(ChatRouter(
        idOrSlug: "premium",
        parameters: {"dream_text": _text},
        initialMessage: _text,
...
class _Instructions extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final listTextStyle = GoogleFonts.openSans(
      fontSize: 22,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Record or type your dream in as much or little detail as you remember:",
            style: GoogleFonts.lora(
              fontSize: 28,
              color: CustomColors.anxiousTeal_0,
            ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "\u2022 emotions, feelings, intents",
                  style: listTextStyle,
                ),
                Text(
                  "\u2022 symbols, objects, odd things",
                  style: listTextStyle,
                ),
                Text("\u2022 anything that stood out", style: listTextStyle),
              ],
            ),
          )
        ],
