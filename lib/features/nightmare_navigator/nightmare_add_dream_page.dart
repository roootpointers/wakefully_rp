...
import 'nightmare_navigator_title_bar.dart';

@RoutePage()
class NightmareAddDreamPage extends StatefulWidget {
  const NightmareAddDreamPage({super.key});

  @override
  State<NightmareAddDreamPage> createState() => _NightmareAddDreamPageState();
}

class _NightmareAddDreamPageState extends State<NightmareAddDreamPage> {
  ...
  void _send() {
    ...
    context.router.push(ChatRouter(
        idOrSlug: "nightmare_navigator",
        flowBlockId: 29,
        parameters: {
          "first_name": firstName,
          "nightmare": _text,
        },
        resultsTitle: "Nightmare Navigator",
        resultsTitleChild: const NightmareNavigatorTitleBar()));
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Please describe the most distressing or frightening moment in your nightmare",
            style: GoogleFonts.lora(
              fontSize: 28,
              color: CustomColors.anxiousTeal_0,
            ),
